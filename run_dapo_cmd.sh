#!/bin/bash
#
# DAPO 训练启动脚本 (使用 swift rlhf 命令) - 8 GPU
#
# 使用方法:
#   chmod +x run_dapo_cmd.sh
#   ./run_dapo_cmd.sh
#
...
torchrun --nproc_per_node=8 \
    ...
    --reward_funcs correctness rule_match soft_overlong \
    ...
    --report_to swanlab \
    --swanlab_project qwen3-14B-Intruct-dapo \
    --swanlab_exp_name qwen3-14B-Intruct-dapo-0319 \
