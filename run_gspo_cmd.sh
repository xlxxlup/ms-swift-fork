#!/bin/bash
#
# GSPO 训练启动脚本 (使用 swift rlhf 命令) - 8 GPU
#
# GSPO (Group Sequence Policy Optimization) 是 GRPO 的改进版本
# 参考: https://arxiv.org/abs/2507.18071
#
# 核心改进:
# - 在序列级别计算重要性采样权重，而非 token 级别
# - 减少梯度估计的高方差噪声，提高训练稳定性
#
# 使用方法:
#   chmod +x run_gspo_cmd.sh
#   ./run_gspo_cmd.sh
#
...
OUTPUT_DIR="${DATA_DIR}/gspo_output"
...
torchrun --nproc_per_node=8 \
    ...
    --report_to swanlab \
    --swanlab_project qwen3-14B-Intruct-gspo \
    --swanlab_exp_name qwen3-14B-Intruct-gspo-0319 \
